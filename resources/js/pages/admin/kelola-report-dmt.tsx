...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Kelola Report DMT',
        href: '/admin/kelola-report-dmt',
    },
];

interface KelolaReportDMTProps {
    reports?: ReportGroup[];
    success?: string;
}

export default function KelolaReportDMT({ reports = [], success }: KelolaReportDMTProps) {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Report DMT</h1>
                        <p className="text-muted-foreground mt-2">
                            Upload report harian DMT secara manual.
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2">
                        <Card>
                            <CardHeader>
                                <CardTitle>Daftar Report DMT</CardTitle>
                                <CardDescription>
                                    Report harian DMT yang sudah diupload.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                {reports.length === 0 ? (
                                    <div className="text-center py-8 text-muted-foreground">
                                        Belum ada report DMT.
                                    </div>
                                ) : (
                    ...
                    <div>
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Panduan upload report harian DMT
                                </CardDescription>
                            </CardHeader>
                ...
                <Dialog open={isDetailOpen} onOpenChange={setIsDetailOpen}>
                    <DialogContent className="sm:max-w-[600px]">
                        <DialogHeader>
                            <DialogTitle>Detail Report DMT - {selectedGroup?.date}</DialogTitle>
                            <CardDescription>
